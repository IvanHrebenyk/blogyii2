...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => 'Головна адмінка', 'url' => ['/admin/default/index']],
            ['label' => 'Статті', 'url' => ['/admin/article/index']],
            ['label' => 'Коментарії', 'url' => ['/admin/comment/index']],
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Курсовий проект, ЧДТУ, ПЗС-1644, Гребенюк Іван </p>
